        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="md:w-64">
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-eske-30 rounded-lg focus-ring-primary"
            >
            ...
            {filteredTags.map((tag) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="w-full bg-gray-eske-20 rounded-full h-2 overflow-hidden mb-2"
                    role="progressbar"
