...
export default function SecondaryImagesManager({
  ...
  return (
    <div className="bg-gray-eske-10 rounded-xl p-4 border border-gray-eske-30">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-xs text-gray-600 bg-white-eske px-2 py-1 rounded-full">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Badge de insertado */}
                  {isInserted && (
                    <div className="absolute top-2 right-2 bg-green-eske text-white text-xs px-2 py-1 rounded-full flex items-center gap-1">
                ...
                {/* Info y acciones */}
                <div className="p-2">
                  <p className="text-xs text-gray-700 truncate mb-2" title={image.filename}>
                    {image.filename}
                  </p>
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      title={isInserted ? "Ya está en el contenido" : "Insertar en el contenido"}
                    >
                    ...
                    <button
                      ...
                      className="px-2 py-1.5 bg-red-eske text-white rounded hover:bg-red-600 transition-colors"
      ...
      {images.length > 0 && (
        <div className="mt-3 pt-3 border-t border-gray-eske-30 text-xs text-gray-600">
          <div className="flex items-center justify-between">
            <span>
              {images.filter(img => isImageInContent(img.url)).length} de {images.length} insertadas
            </span>
            <span>
              Total: {images.reduce((acc, img) => acc + (img.size || 0), 0) > 0 
