...
function ProjectCard({ project }: { project: ModduloProject }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 text-xs text-gray-eske-50">
...
export default function ProyectosPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-eske-10 p-8">
      <div className="max-w-4xl mx-auto">
        {/* Back link */}
        <Link
          href="/moddulo"
          className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-eske-50 hover:text-bluegreen-eske transition-colors mb-6"
        >
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-eske-80">Mis Proyectos</h1>
            <p className="text-gray-eske-60 mt-1 text-sm">
              {projects.length > 0
        ...
        {isLoading ? (
          ...
          <div className="bg-white-eske rounded-xl border border-red-200 p-8 text-center">
          ...
          <div className="bg-white-eske rounded-xl border border-gray-eske-20 p-12 text-center">
            ...
            <p className="text-gray-eske-50 mb-6 text-sm">
