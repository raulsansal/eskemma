// app/moddulo/proyecto/[projectId]/tactica/page.tsx
"use client";
export default function DiseñoTácticoPage() {
  return (
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <span className="text-xs font-semibold uppercase tracking-widest text-bluegreen-eske">Fase 6</span>
