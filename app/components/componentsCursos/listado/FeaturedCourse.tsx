...
export default function FeaturedCourse({ 
  ...
  return (
    <div className="bg-white-eske rounded-2xl p-6 md:p-8 mb-10 border border-bluegreen-eske/20 shadow-md flex flex-col md:flex-row gap-6 items-center hover:shadow-lg transition-all">
      <div className="flex-1 text-center md:text-left">
        <span className="inline-block bg-green-eske text-white-eske px-4 py-1 rounded-full text-xs font-semibold mb-3">
          {tag}
        </span>
        <h2 className="text-2xl md:text-3xl font-bold text-blue-eske-900 mb-2">
          {title}
        </h2>
        <p className="text-black-eske mb-4 font-normal">
          {description}
        </p>
      ...
      <div className="w-full md:w-1/3 h-48 bg-white rounded-xl flex items-center justify-center overflow-hidden border border-gray-eske-10">
        {image ? (
          <img 
            src={image} 
            alt={title} 
