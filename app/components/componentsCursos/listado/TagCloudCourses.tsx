...
export default function TagCloudCourses({ tags }: TagCloudCoursesProps) {
  ...
  return (
    <div className="bg-white-eske rounded-lg shadow-sm p-6 mb-6 border border-gray-eske-10">
      ...
      <div className="flex flex-wrap gap-2">
        {tags.map((tag) => (
          <Link
            ...
            className="inline-block px-3 py-1 bg-gray-100 hover:bg-bluegreen-eske hover:text-white-eske text-gray-700 rounded-full transition-colors text-xs font-medium"
          >
            {tag.tag}
          </Link>
        ))}
