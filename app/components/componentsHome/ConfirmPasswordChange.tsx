// app/components/componentsHome/ConfirmPasswordChange.tsx
"use client";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Contenido del Modal */}
        <h2 id="confirm-password-title" className="text-xl max-sm:text-lg font-medium text-bluegreen-eske text-center mb-6 max-sm:mb-4">
