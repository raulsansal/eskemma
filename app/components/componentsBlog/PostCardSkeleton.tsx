...
export default function PostCardSkeleton() {
  return (
    <div
      className="flex flex-col items-center text-center bg-white-eske rounded-lg shadow-md p-6 animate-pulse"
      role="status"
      aria-busy="true"
    ...
    >
      {/* Skeleton de imagen */}
      <div
        className="w-full h-48 bg-gray-eske-20 rounded-lg mb-4"
        aria-hidden="true"
      ></div>
      ...
      {/* Skeleton de botón */}
      <div
        className="w-full h-10 bg-gray-eske-20 rounded-lg"
        aria-hidden="true"
      ></div>
