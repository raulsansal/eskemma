...
const LEVEL_STYLES = {
  low:    {bar: "bg-green-500",  text: "text-green-600",  bg: "bg-green-50",  label: "Bajo"},
  medium: {bar: "bg-yellow-400", text: "text-yellow-600", bg: "bg-yellow-50", label: "Moderado"},
  high:   {bar: "bg-red-500",    text: "text-red-600",    bg: "bg-red-50",    label: "Alto"},
};
