      ...
      {open && (
        <span
          ...
          className={[
            ...
            "w-64 sm:w-72",
            "bg-white-eske border border-gray-eske-20 rounded-lg shadow-lg",
            "p-3 flex flex-col gap-1.5",
            "motion-safe:animate-in motion-safe:fade-in motion-safe:zoom-in-95",
            "motion-safe:duration-100",
          ].join(" ")}
        >
          <p className="text-xs text-black-eske leading-relaxed">{content}</p>
          {example && (
            <p className="text-xs text-gray-eske-60 italic border-t border-gray-eske-10 pt-1.5">
              <span className="not-italic font-medium text-gray-eske-70">
                Ej:{" "}
              </span>
              {example}
            </p>
